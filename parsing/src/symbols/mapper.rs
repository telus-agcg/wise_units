...
use prefix::Prefix;
use symbols::symbol_parser::Rule;
...
fn visit_atom(pair: &Pair<Rule>) -> Result<Atom, Error> {
    let atom = match pair.as_rule() {
        ...
        Rule::pri_calorie_nutrition_label | Rule::sec_calorie_nutrition_label => {
        ...
        Rule::pri_long_hundredweight_av | Rule::sec_long_hundredweight_av => {
        ...
        Rule::pri_link_for_gunters_chain_br | Rule::sec_link_for_gunters_chain_br => {
        ...
        Rule::pri_queen_annes_wine_gallon | Rule::sec_queen_annes_wine_gallon => {
        ...
        Rule::pri_short_hundredweight_av | Rule::sec_short_hundredweight_av => {

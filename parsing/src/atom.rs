...
mod tests {
    ...
    fn validate_definition_degree_celsius() {
        ...
        let term = Term::new(Some(Atom::Kelvin), None);
    ...
    fn validate_definition_degree_fahrenheit() {
        ...
        let term1 = Term::new(Some(Atom::Kelvin), None);
        let mut term2 = Term::new(None, None);
        term2.factor = 9;
        term2.exponent = -1;

        assert_eq!(atom.definition().value, 5.0);
    ...
    fn validate_definition_ph() {
        let atom = Atom::PH;
        let term1 = Term::new(Some(Atom::Mole), None);
        let mut term2 = Term::new(Some(Atom::Liter), None);
        term2.exponent = -1;
    ...
    fn validate_definition_prism_diopter() {
        ...
        let term = Term::new(Some(Atom::Radian), None);
        let terms = vec![term];
    ...
    #[test]
    fn validate_definition_bel_watt() {
        let atom = Atom::BelWatt;
        let term = Term::new(Some(Atom::Watt), None);
        let terms = vec![term];
    ...
    fn validate_definition_quart_us() {
        ...
        let term = Term::new(Some(Atom::QueenAnnesWineGallonUS), None);
    ...
    fn validate_definition_cup_m() {
        let atom = Atom::MetricCup;
        let term = Term::new(Some(Atom::LiterSecondary), Some(Prefix::Milli));
    ...
    fn validate_definition_queen_annes_wine_gallon_us() {
        let atom = Atom::QueenAnnesWineGallonUS;
    ...
    validate_scalars!(
        ...
        validate_scalar_atomic_mass_unit, UnifiedAtomicMassUnit, 1.660_540_2e-24;

...
impl Atom {
    pub(crate) fn definition(self) -> Definition {
        let result = match self {
            ...
            Self::DegreeCelsius => Definition::new(1.0, "K", Some(FunctionSet { convert_from: |value: f64| value - 273.15, convert_to: |value: f64| value + 273.15 })),
            ...
            Self::UnifiedAtomicMassUnit => Definition::new(0.0000000000000000000000016605402, "g", None),
            ...
            Self::PlanckConstant => Definition::new(0.00000000000000000000000000000000066260755, "J.s", None),
            Self::BoltzmannConstant => Definition::new(0.00000000000000000000001380658, "J/K", None),
            ...
            Self::NewtonianConstantOfGravitation => Definition::new(0.0000000000667259, "m3.kg-1.s-2", None),
            ...
            Self::DegreeFahrenheit => Definition::new(5.0, "K/9", Some(FunctionSet { convert_from: |value: f64| 9.0 * value / 5.0 - 459.67, convert_to: |value: f64| 5.0 / 9.0 * (value + 459.67) })),
            Self::DegreeRankine => Definition::new(5.0, "K/9", None),
            Self::DegreeReaumur => Definition::new(5.0, "K/4", Some(FunctionSet { convert_from: |value: f64| (value - 273.15) * 0.8, convert_to: |value: f64| (value / 0.8) + 273.15 })),
            ...
            Self::InternationalTableBritishThermalUnit => Definition::new(1.05505585262, "kJ", None),
            ...
            Self::PrismDiopter => Definition::new(1.0, "rad", Some(FunctionSet { convert_from: |value: f64| (value / 100.0).atan(), convert_to: |value: f64| value.tan() * 100.0 })),
            Self::PercentOfSlope => Definition::new(1.0, "deg", Some(FunctionSet { convert_from: |value: f64| (value / 100.0).atan(), convert_to: |value: f64| value.tan() * 100.0 })),
            ...
            Self::HomeopathicPotencyOfDecimalSeriesRetired => Definition::new(1.0, "1", Some(FunctionSet { convert_from: |value: f64| -value.log10(), convert_to: |value: f64| 10_f64.powf(-value) })),
            Self::HomeopathicPotencyOfCentesimalSeriesRetired => Definition::new(1.0, "1", Some(FunctionSet { convert_from: |value: f64| -value.ln() / 100_f64.ln(), convert_to: |value: f64| 100_f64.powf(-value) })),
            Self::HomeopathicPotencyOfMillesimalSeriesRetired => Definition::new(1.0, "1", Some(FunctionSet { convert_from: |value: f64| -value.ln() / 1_000_f64.ln(), convert_to: |value: f64| 1_000_f64.powf(-value) })),
            Self::HomeopathicPotencyOfQuintamillesimalSeriesRetired => Definition::new(1.0, "1", Some(FunctionSet { convert_from: |value: f64| -value.ln() / 50_000_f64.ln(), convert_to: |value: f64| 50_000_f64.powf(-value) })),
            ...
            Self::HomeopathicPotencyOfQuintamillesimalHahnemannianSeries => Ok(Definition::default()),
            ...
            Self::HomeopathicPotencyOfQuintamillesimalKorsakovianSeries => Ok(Definition::default()),
            Self::Equivalents => Definition::new(1.0, "mol", None),
            Self::Osmole => Definition::new(1.0, "mol", None),
            Self::PH => Definition::new(1.0, "mol/l", Some(FunctionSet { convert_from: |value: f64| 10.0_f64.powf(-value), convert_to: |value: f64| -value.log10() })),
            ...
            Self::Neper => Definition::new(1.0, "1", Some(FunctionSet { convert_from: |value: f64| value.ln(), convert_to: |value: f64| ::std::f64::consts::E.powf(value) })),
            Self::Bel => Definition::new(1.0, "1", Some(FunctionSet { convert_from: |value: f64| value.log10(), convert_to: |value: f64| 10_f64.powf(value) })),
            Self::BelSoundPressure => Definition::new(2.0, "10*-5.Pa", Some(FunctionSet { convert_from: |value: f64| 2.0 * value.log10(), convert_to: |value: f64| 10_f64.powf(value / 2.0) })),
            Self::BelVolt => Definition::new(1.0, "V", Some(FunctionSet { convert_from: |value: f64| 2.0 * value.log10(), convert_to: |value: f64| 10_f64.powf(value / 2.0) })),
            Self::BelMillivolt => Definition::new(1.0, "mV", Some(FunctionSet { convert_from: |value: f64| 2.0 * value.log10(), convert_to: |value: f64| 10_f64.powf(value / 2.0) })),
            Self::BelMicrovolt => Definition::new(1.0, "uV", Some(FunctionSet { convert_from: |value: f64| 2.0 * value.log10(), convert_to: |value: f64| 10_f64.powf(value / 2.0) })),
            Self::Bel10Nanovolt => Definition::new(10.0, "nV", Some(FunctionSet { convert_from: |value: f64| 2.0 * value.log10(), convert_to: |value: f64| 10_f64.powf(value / 2.0) })),
            Self::BelWatt => Definition::new(1.0, "W", Some(FunctionSet { convert_from: |value: f64| value.log10(), convert_to: |value: f64| 10_f64.powf(value) })),
            Self::BelKilowatt => Definition::new(1.0, "kW", Some(FunctionSet { convert_from: |value: f64| value.log10(), convert_to: |value: f64| 10_f64.powf(value) })),
            ...
            Self::MeterPerSquareSecondsPerSquareRootOfHertz => Definition::new(1.0, "m2/s4/Hz", Some(FunctionSet { convert_from: |value: f64| value.sqrt(), convert_to: |value: f64| value.powi(2) })),
            Self::BitLogarithmusDualis => Definition::new(1.0, "1", Some(FunctionSet { convert_from: |value: f64| value.log2(), convert_to: |value: f64| 2_f64.powf(value) })),
...
impl UcumSymbol for Atom {
    fn classification(&self) -> Classification {
        match *self {
            ...
            Self::HomeopathicPotencyOfQuintamillesimalHahnemannianSeries => Classification::Clinical,
    ...
    fn names(&self) -> Vec<&'static str> {
        match *self {
            ...
            Self::TheNumberTenForArbitraryPowersCaret => vec!["the number ten for arbitrary powers",],
            ...
            Self::ShortHundredweightAvoirdupois => vec!["short hundredweight","U.S. hundredweight",],
            Self::LongHunderdweightAvoirdupois => vec!["long hunderdweight","British hundredweight",],
            ...
            Self::InternationalTableBritishThermalUnit => vec!["international table British thermal unit",],
            ...
            Self::HomeopathicPotencyOfDecimalSeriesRetired => vec!["homeopathic potency of decimal series (retired)",],
            Self::HomeopathicPotencyOfCentesimalSeriesRetired => vec!["homeopathic potency of centesimal series (retired)",],
            Self::HomeopathicPotencyOfMillesimalSeriesRetired => vec!["homeopathic potency of millesimal series (retired)",],
            Self::HomeopathicPotencyOfQuintamillesimalSeriesRetired => vec!["homeopathic potency of quintamillesimal series (retired)",],
            Self::HomeopathicPotencyOfDecimalHahnemannianSeries => vec!["homeopathic potency of decimal hahnemannian series",],
            Self::HomeopathicPotencyOfCentesimalHahnemannianSeries => vec!["homeopathic potency of centesimal hahnemannian series",],
            Self::HomeopathicPotencyOfMillesimalHahnemannianSeries => vec!["homeopathic potency of millesimal hahnemannian series",],
            Self::HomeopathicPotencyOfQuintamillesimalHahnemannianSeries => vec!["homeopathic potency of quintamillesimal hahnemannian series",],
            Self::HomeopathicPotencyOfDecimalKorsakovianSeries => vec!["homeopathic potency of decimal korsakovian series",],
            Self::HomeopathicPotencyOfCentesimalKorsakovianSeries => vec!["homeopathic potency of centesimal korsakovian series",],
            Self::HomeopathicPotencyOfMillesimalKorsakovianSeries => vec!["homeopathic potency of millesimal korsakovian series",],
            Self::HomeopathicPotencyOfQuintamillesimalKorsakovianSeries => vec!["homeopathic potency of quintamillesimal korsakovian series",],
            ...
            Self::AllergenUnitForAmbrosiaArtemisiifolia => vec!["allergen unit for Ambrosia artemisiifolia",],
            ...
            Self::MeterPerSquareSecondsPerSquareRootOfHertz => vec!["meter per square seconds per square root of hertz",],

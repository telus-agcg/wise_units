...
impl Atom {
    pub(crate) fn definition(self) -> Definition<f64> {
        match self {
            ...
            Self::TheNumberTenForArbitraryPowersStar => Definition::Value(10f64),
            Self::TheNumberTenForArbitraryPowersCaret => Definition::Value(10f64),
            Self::TheNumberPi => Definition::Value(::std::f64::consts::PI),
            Self::Percent => Definition::Value(0.01),
            Self::PartsPerThousand => PARTS_PER_THOUSAND,
            Self::PartsPerMillion => PARTS_PER_MILLION,
            Self::PartsPerBillion => PARTS_PER_BILLION,
            Self::PartsPerTrillion => PARTS_PER_TRILLION,
            Self::Mole => MOLE,
            Self::Steradian => STERADIAN,
            Self::Hertz => HERTZ,
            Self::Newton => Definition::new_value_terms(1f64, "kg.m/s2"),
            Self::Pascal => Definition::new_value_terms(1f64, "N/m2"),
            Self::Joule => Definition::new_value_terms(1f64, "N.m"),
            Self::Watt => Definition::new_value_terms(1f64, "J/s"),
            Self::Ampere => Definition::new_value_terms(1f64, "C/s"),
            Self::Volt => Definition::new_value_terms(1f64, "J/C"),
            Self::Farad => Definition::new_value_terms(1f64, "C/V"),
            Self::Ohm => Definition::new_value_terms(1f64, "V/A"),
            Self::Siemens => SIEMENS,
            Self::Weber => Definition::new_value_terms(1f64, "V.s"),
            Self::DegreeCelsius => DEGREE_CELSIUS,
            Self::Tesla => Definition::new_value_terms(1f64, "Wb/m2"),
            Self::Henry => Definition::new_value_terms(1f64, "Wb/A"),
            Self::Lumen => Definition::new_value_terms(1f64, "cd.sr"),
            Self::Lux => Definition::new_value_terms(1f64, "lm/m2"),
            Self::Becquerel => BECQUEREL,
            Self::Gray => Definition::new_value_terms(1f64, "J/kg"),
            Self::Sievert => Definition::new_value_terms(1f64, "J/kg"),
            Self::Gon => GON,
            Self::Degree => Definition::new_value_terms(2f64, "[pi].rad/360"),
            Self::MinuteAngle => Definition::new_value_terms(1f64, "deg/60"),
            Self::SecondAngle => Definition::new_value_terms(1f64, "'/60"),
            Self::Liter => LITER,
            Self::LiterSecondary => LITER,
            Self::Are => ARE,
            Self::Minute => MINUTE,
            Self::Hour => HOUR,
            Self::Day => DAY,
            Self::TropicalYear => TROPICAL_YEAR,
            Self::MeanJulianYear => MEAN_JULIAN_YEAR,
            Self::MeanGregorianYear => MEAN_GREGORIAN_YEAR,
            Self::Year => YEAR,
            Self::Week => WEEK,
            Self::SynodalMonth => SYNODAL_MONTH,
            Self::MeanJulianMonth => Definition::new_value_terms(1f64, "a_j/12"),
            Self::MeanGregorianMonth => Definition::new_value_terms(1f64, "a_g/12"),
            Self::Month => MONTH,
            Self::Tonne => TONNE,
            Self::Bar => BAR,
            Self::UnifiedAtomicMassUnit => UNIFIED_ATOMIC_MASS_UNIT,
            Self::Electronvolt => Definition::new_value_terms(1f64, "[e].V"),
            Self::AstronomicUnit => ASTRONOMIC_UNIT,
            Self::Parsec => PARSEC,
            Self::VelocityOfLight => Definition::new_value_terms(299792458f64, "m/s"),
            Self::PlanckConstant => {
                Definition::new_value_terms(0.00000000000000000000000000000000066260755f64, "J.s")
            }
            Self::BoltzmannConstant => {
                Definition::new_value_terms(0.00000000000000000000001380658f64, "J/K")
            }
            Self::PermittivityOfVacuum => {
                Definition::new_value_terms(0.000000000008854187817f64, "F/m")
            }
            Self::PermeabilityOfVacuum => Definition::new_value_terms(1f64, "4.[pi].10*-7.N/A2"),
            Self::ElementaryCharge => ELEMENTARY_CHARGE,
            Self::ElectronMass => ELECTRON_MASS,
            Self::ProtonMass => PROTON_MASS,
            Self::NewtonianConstantOfGravitation => {
                Definition::new_value_terms(0.0000000000667259f64, "m3.kg-1.s-2")
            }
            Self::StandardAccelerationOfFreeFall => Definition::new_value_terms(9.80665f64, "m/s2"),
            Self::StandardAtmosphere => STANDARD_ATMOSPHERE,
            Self::LightYear => Definition::new_value_terms(1f64, "[c].a_j"),
            Self::GramForce => Definition::new_value_terms(1f64, "g.[g]"),
            Self::PoundForceAvoirdupois => Definition::new_value_terms(1f64, "[lb_av].[g]"),
            Self::Kayser => KAYSER,
            Self::Gal => Definition::new_value_terms(1f64, "cm/s2"),
            Self::Dyne => Definition::new_value_terms(1f64, "g.cm/s2"),
            Self::Erg => Definition::new_value_terms(1f64, "dyn.cm"),
            Self::Poise => Definition::new_value_terms(1f64, "dyn.s/cm2"),
            Self::Biot => BIOT,
            Self::Stokes => Definition::new_value_terms(1f64, "cm2/s"),
            Self::Maxwell => MAXWELL,
            Self::Gauss => GAUSS,
            Self::Oersted => Definition::new_value_terms(250f64, "/[pi].A/m"),
            Self::Gilbert => Definition::new_value_terms(1f64, "Oe.cm"),
            Self::Stilb => Definition::new_value_terms(1f64, "cd/cm2"),
            Self::Lambert => Definition::new_value_terms(1f64, "cd/cm2/[pi]"),
            Self::Phot => PHOT,
            Self::Curie => CURIE,
            Self::Roentgen => Definition::new_value_terms(0.000258f64, "C/kg"),
            Self::RadiationAbsorbedDose => Definition::new_value_terms(100f64, "erg/g"),
            Self::RadiationEquivalentMan => Definition::new_value_terms(1f64, "RAD"),
            Self::InchInternational => INCH_INTERNATIONAL,
            Self::FootInternational => FOOT_INTERNATIONAL,
            Self::YardInternational => YARD_INTERNATIONAL,
            Self::MileInternational => MILE_INTERNATIONAL,
            Self::FathomInternational => FATHOM_INTERNATIONAL,
            Self::NauticalMileInternational => NAUTICAL_MILE_INTERNATIONAL,
            Self::KnotInternational => Definition::new_value_terms(1f64, "[nmi_i]/h"),
            Self::SquareInchInternational => SQUARE_INCH_INTERNATIONAL,
            Self::SquareFootInternational => SQUARE_FOOT_INTERNATIONAL,
            Self::SquareYardInternational => SQUARE_YARD_INTERNATIONAL,
            Self::CubicInchInternational => CUBIC_INCH_INTERNATIONAL,
            Self::CubicFootInternational => CUBIC_FOOT_INTERNATIONAL,
            Self::CubicYardInternational => CUBIC_YARD_INTERNATIONAL,
            Self::BoardFootInternational => BOARD_FOOT_INTERNATIONAL,
            Self::CordInternational => CORD_INTERNATIONAL,
            Self::MilInternational => MIL_INTERNATIONAL,
            Self::CircularMilInternational => Definition::new_value_terms(1f64, "[pi]/4.[mil_i]2"),
            Self::HandInternational => HAND_INTERNATIONAL,
            Self::FootUS => Definition::new_value_terms(1200f64, "m/3937"),
            Self::YardUS => YARD_US,
            Self::InchUS => Definition::new_value_terms(1f64, "[ft_us]/12"),
            Self::RodUS => ROD_US,
            Self::GuntersChainUS => GUNTERS_CHAIN_US,
            Self::LinkForGuntersChainUS => Definition::new_value_terms(1f64, "[ch_us]/100"),
            Self::RamdensChainUS => RAMDENS_CHAIN_US,
            Self::LinkForRamdensChainUS => Definition::new_value_terms(1f64, "[rch_us]/100"),
            Self::FathomUS => FATHOM_US,
            Self::FurlongUS => FURLONG_US,
            Self::MileUS => MILE_US,
            Self::AcreUS => ACRE_US,
            Self::SquareRodUS => SQUARE_ROD_US,
            Self::SquareMileUS => SQUARE_MILE_US,
            Self::Section => SECTION,
            Self::Township => TOWNSHIP,
            Self::MilUS => MIL_US,
            Self::InchBritish => INCH_BRITISH,
            Self::FootBritish => FOOT_BRITISH,
            Self::RodBritish => ROD_BRITISH,
            Self::GuntersChainBritish => GUNTERS_CHAIN_BRITISH,
            Self::LinkForGuntersChainBritish => Definition::new_value_terms(1f64, "[ch_br]/100"),
            Self::FathomBritish => FATHOM_BRITISH,
            Self::PaceBritish => PACE_BRITISH,
            Self::YardBritish => YARD_BRITISH,
            Self::MileBritish => MILE_BRITISH,
            Self::NauticalMileBritish => NAUTICLE_MILE_BRITISH,
            Self::KnotBritish => Definition::new_value_terms(1f64, "[nmi_br]/h"),
            Self::AcreBritish => ACRE_BRITISH,
            Self::QueenAnnesWineGallonUS => QUEEN_ANNES_WINE_GALLON_US,
            Self::BarrelUS => BARREL_US,
            Self::QuartUS => Definition::new_value_terms(1f64, "[gal_us]/4"),
            Self::PintUS => Definition::new_value_terms(1f64, "[qt_us]/2"),
            Self::GillUS => Definition::new_value_terms(1f64, "[pt_us]/4"),
            Self::FluidOunceUS => Definition::new_value_terms(1f64, "[gil_us]/4"),
            Self::FluidDramUS => Definition::new_value_terms(1f64, "[foz_us]/8"),
            Self::MinimUS => Definition::new_value_terms(1f64, "[fdr_us]/60"),
            Self::CordUS => CORD_US,
            Self::BushelUS => BUSHEL_US,
            Self::HistoricalWinchesterGallon => Definition::new_value_terms(1f64, "[bu_us]/8"),
            Self::PeckUS => Definition::new_value_terms(1f64, "[bu_us]/4"),
            Self::DryQuartUS => Definition::new_value_terms(1f64, "[pk_us]/8"),
            Self::DryPintUS => Definition::new_value_terms(1f64, "[dqt_us]/2"),
            Self::TablespoonUS => Definition::new_value_terms(1f64, "[foz_us]/2"),
            Self::TeaspoonUS => Definition::new_value_terms(1f64, "[tbs_us]/3"),
            Self::CupUS => CUP_US,
            Self::MetricFluidOunce => METRIC_FLUID_OUNCE,
            Self::MetricCup => METRIC_CUP,
            Self::MetricTeaspoon => METRIC_TEASPOON,
            Self::MetricTablespoon => METRIC_TABLESPOON,
            Self::GallonBritish => GALLON_BRITISH,
            Self::PeckBritish => PECK_BRITISH,
            Self::BushelBritish => BUSHEL_BRITISH,
            Self::QuartBritish => Definition::new_value_terms(1f64, "[gal_br]/4"),
            Self::PintBritish => Definition::new_value_terms(1f64, "[qt_br]/2"),
            Self::GillBritish => Definition::new_value_terms(1f64, "[pt_br]/4"),
            Self::FluidOunceBritish => Definition::new_value_terms(1f64, "[gil_br]/5"),
            Self::FluidDramBritish => Definition::new_value_terms(1f64, "[foz_br]/8"),
            Self::MinimBritish => Definition::new_value_terms(1f64, "[fdr_br]/60"),
            Self::Grain => GRAIN,
            Self::PoundAvoirdupois => POUND_AVOIRDUPOIS,
            Self::OunceAvoirdupois => Definition::new_value_terms(1f64, "[lb_av]/16"),
            Self::DramAvoirdupois => Definition::new_value_terms(1f64, "[oz_av]/16"),
            Self::ShortHundredweightAvoirdupois => SHORT_HUNDREDWEIGHT_AVOIRDUPOIS,
            Self::LongHunderdweightAvoirdupois => LONG_HUNDREDWEIGHT_AVOIRDUPOIS,
            Self::ShortTonAvoirdupois => SHORT_TON_AVOIRDUPOIS,
            Self::LongTonAvoirdupois => LONG_TON_AVOIRDUPOIS,
            Self::StoneAvoirdupois => STONE_AVOIRDUPOIS,
            Self::PennyweightTroy => PENNYWEIGHT_TROY,
            Self::OunceTroy => OUNCE_TROY,
            Self::PoundTroy => POUND_TROY,
            Self::ScrupleApothecaries => SCUPLE_APOTHECARIES,
            Self::DramApothecaries => DRAM_APOTHECARIES,
            Self::OunceApothecaries => OUNCE_APOTHECARIES,
            Self::PoundApothecaries => POUND_APOTHECARIES,
            Self::MetricOunce => METRIC_OUNCE,
            Self::Line => Definition::new_value_terms(1f64, "[in_i]/12"),
            Self::Point => Definition::new_value_terms(1f64, "[lne]/6"),
            Self::Pica => PICA,
            Self::PrintersPoint => PRINTERS_POINT,
            Self::PrintersPica => PRINTERS_PICA,
            Self::Pied => PIED,
            Self::Pouce => Definition::new_value_terms(1f64, "[pied]/12"),
            Self::Ligne => Definition::new_value_terms(1f64, "[pouce]/12"),
            Self::Didot => Definition::new_value_terms(1f64, "[ligne]/6"),
            Self::Cicero => CICERO,
            Self::DegreeFahrenheit => Definition::new_value_terms_special(
                5f64,
                "K/9",
                FunctionSet {
            ...
            Self::DegreeRankine => Definition::new_value_terms(5f64, "K/9"),
            Self::DegreeReaumur => Definition::new_value_terms_special(
                5f64,
                "K/4",
                FunctionSet {
            ...
            Self::CalorieAt15C => CALORIE_AT_15C,
            Self::CalorieAt20C => CALORIE_AT_20C,
            Self::MeanCalorie => MEAN_CALORIE,
            Self::InternationalTableCalorie => INTERNATIONAL_TABLE_CALORIE,
            Self::ThermochemicalCalorie => THERMOCHEMICAL_CALORIE,
            Self::Calorie => CALORIE,
            Self::NutritionLabelCalories => NUTRITION_LABEL_CALORIES,
            Self::BritishThermalUnitAt39F => BRITISH_THERMAL_UNIT_AT_39F,
            Self::BritishThermalUnitAt59F => BRITISH_THERMAL_UNIT_AT_59F,
            Self::BritishThermalUnitAt60F => BRITISH_THERMAL_UNIT_AT_60F,
            Self::MeanBritishThermalUnit => MEAN_BRITISH_THERMAL_UNIT,
            Self::InternationalTableBritishThermalUnit => INTERNATIONAL_TABLE_BRITISH_THERMAL_UNIT,
            Self::ThermochemicalBritishThermalUnit => THERMOCHEMICAL_BRITISH_THERMAL_UNIT,
            Self::BritishThermalUnit => BRITISH_THERMAL_UNIT,
            Self::Horsepower => Definition::new_value_terms(550f64, "[ft_i].[lbf_av]/s"),
            Self::Tex => Definition::new_value_terms(1f64, "g/km"),
            Self::Denier => Definition::new_value_terms(1f64, "g/9/km"),
            Self::MeterOfWaterColumn => METER_OF_WATER_COLUMN,
            Self::MeterOfMercuryColumn => METER_OF_MERCURY_COLUMN,
            Self::InchOfWaterColumn => Definition::new_value_terms(1f64, "m[H2O].[in_i]/m"),
            Self::InchOfMercuryColumn => Definition::new_value_terms(1f64, "m[Hg].[in_i]/m"),
            Self::PeripheralVascularResistanceUnit => {
                Definition::new_value_terms(1f64, "mm[Hg].s/ml")
            }
            Self::WoodUnit => Definition::new_value_terms(1f64, "mm[Hg].min/L"),
            Self::Diopter => Definition::new_value_terms(1f64, "/m"),
            Self::PrismDiopter => PRISM_DIOPTER,
            Self::PercentOfSlope => PERCENT_OF_SLOPE,
            Self::MeshInternational => Definition::new_value_terms(1f64, "/[in_i]"),
            Self::Charriere => Definition::new_value_terms(1f64, "mm/3"),
            Self::Drop => Definition::new_value_terms(1f64, "ml/20"),
            Self::HounsfieldUnit => ONE,
            Self::MetabolicEquivalent => Definition::new_value_terms(3.5f64, "mL/min/kg"),
            Self::HomeopathicPotencyOfDecimalSeriesRetired => {
                HOMEOPATHIC_POTENCY_OF_DECIMAL_SERIES_RETIRED
            }
            Self::HomeopathicPotencyOfCentesimalSeriesRetired => {
                HOMEOPATHIC_POTENCY_OF_CENTESIMAL_SERIES_RETIRED
            }
            Self::HomeopathicPotencyOfMillesimalSeriesRetired => {
                HOMEOPATHIC_POTENCY_OF_MILLESIMAL_SERIES_RETIRED
            }
            Self::HomeopathicPotencyOfQuintamillesimalSeriesRetired => {
                HOMEOPATHIC_POTENCY_OF_QUINTMILLESIMAL_SERIES_RETIRED
            }
            Self::HomeopathicPotencyOfDecimalHahnemannianSeries => ONE,
            Self::HomeopathicPotencyOfCentesimalHahnemannianSeries => ONE,
            Self::HomeopathicPotencyOfMillesimalHahnemannianSeries => ONE,
            Self::HomeopathicPotencyOfQuintamillesimalHahnemannianSeries => ONE,
            Self::HomeopathicPotencyOfDecimalKorsakovianSeries => ONE,
            Self::HomeopathicPotencyOfCentesimalKorsakovianSeries => ONE,
            Self::HomeopathicPotencyOfMillesimalKorsakovianSeries => ONE,
            Self::HomeopathicPotencyOfQuintamillesimalKorsakovianSeries => ONE,
            Self::Equivalents => EQUIVALENTS,
            Self::Osmole => OSMOLE,
            Self::PH => Definition::new_value_terms_special(
                1f64,
                "mol/l",
                FunctionSet {
            ...
            Self::GramPercent => Definition::new_value_terms(1f64, "g/dl"),
            Self::SvedbergUnit => Definition::new_value_terms(1f64, "10*-13.s"),
            Self::HighPowerField => ONE,
            Self::LowPowerField => Definition::Value(100.0),
            Self::Katal => Definition::new_value_terms(1f64, "mol/s"),
            Self::Unit => Definition::new_value_terms(1f64, "umol/min"),
            Self::InternationalUnit => ONE,
            Self::InternationalUnitSecondary => INTERNATIONAL_UNIT_SECONDARY,
            Self::ArbitraryUnit => ONE,
            Self::UnitedStatesPharmacopeiaUnit => ONE,
            Self::GplUnit => ONE,
            Self::MplUnit => ONE,
            Self::AplUnit => ONE,
            Self::BethesdaUnit => ONE,
            Self::AntiFactorXaUnit => ONE,
            Self::ToddUnit => ONE,
            Self::DyeUnit => ONE,
            Self::SomogyiUnit => ONE,
            Self::BodanskyUnit => ONE,
            Self::KingArmstrongUnit => ONE,
            Self::KunkelUnit => ONE,
            Self::MacLaganUnit => ONE,
            Self::TuberculinUnit => ONE,
            Self::CellCultureInfectiousDose => ONE,
            Self::TissueCultureInfectiousDose => ONE,
            Self::EmbryoInfectiousDose => ONE,
            Self::PlaqueFormingUnits => ONE,
            Self::FocusFormingUnits => ONE,
            Self::ColonyFormingUnits => ONE,
            Self::IndexOfReactivity => ONE,
            Self::BioequivalentAllergenUnit => ONE,
            Self::AllergenUnit => ONE,
            Self::AllergenUnitForAmbrosiaArtemisiifolia => ONE,
            Self::ProteinNitrogenUnit => ONE,
            Self::LimitOfFlocculation => ONE,
            Self::DAntigenUnit => ONE,
            Self::FibrinogenEquivalentUnit => ONE,
            Self::ElisaUnit => ONE,
            Self::EhrlichUnit => ONE,
            Self::Neper => NEPER,
            Self::Bel => BEL,
            Self::BelSoundPressure => Definition::new_value_terms_special(
                2f64,
                "10*-5.Pa",
                FunctionSet {
            ...
            Self::BelVolt => BEL_VOLT,
            Self::BelMillivolt => BEL_MILLIVOLT,
            Self::BelMicrovolt => BEL_MICROVOLT,
            Self::Bel10Nanovolt => BEL_10_NANOVOLT,
            Self::BelWatt => BEL_WATT,
            Self::BelKilowatt => BEL_KILOWATT,
            Self::Stere => STERE,
            ...
            Self::CaratOfGoldAlloys => Definition::new_value_terms(1f64, "/24"),
            Self::Smoot => SMOOT,
            Self::MeterPerSquareSecondsPerSquareRootOfHertz => Definition::new_value_terms_special(
                1f64,
                "m2/s4/Hz",
                FunctionSet {
            ...
            Self::BitLogarithmusDualis => BIT_LOGARITHMUS_DUALIS,
            Self::Bit => ONE,
            Self::Byte => BYTE,
            Self::Baud => Definition::new_value_terms(1f64, "/s"),
        }
    }
    #[must_use]

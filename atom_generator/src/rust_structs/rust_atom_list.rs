...
impl RustAtomList {
    ...
    pub(crate) fn v2_classified_impl(&self) -> TokenStream {
        ...
        quote! {
            ...
            #[cfg(feature = "v2")]
            impl crate::v2::traits::ucum::UcumClassified for Atom {
    ...
    pub(crate) fn v2_names_ts(&self) -> TokenStream {
        ...
        match self.names.len() {
            1 => {
                ...
                quote! {
                    Self::#atom_variant => crate::v2::traits::ucum::Names::One(#name)
                }
            }
            2 => {
                ...
                quote! {
                    Self::#atom_variant => crate::v2::traits::ucum::Names::Two((#name0, #name1))
                }
            }
